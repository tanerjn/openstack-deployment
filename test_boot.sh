...
neutron port-create internal_network --name c1_int --fixed-ip ip_address=192.168.7.55
...
neutron port-create internal_network --name c2_int --fixed-ip ip_address=192.168.7.66
...
t2_int_pid=$(neutron port-list | awk '/c2_int/ {print $2}')
